...
#'   \item A function \code{cva.glmnet} to choose both the alpha and lambda parameters via cross-validation, following the approach described in the help page for \code{cv.glmnet}. Optionally does the cross-validation in parallel.
...
#' @importFrom stats coef model.extract model.matrix model.response na.pass predict terms .getXlevels delete.response
NULL
